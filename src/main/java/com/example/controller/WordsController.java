...
public class WordsController extends BaseController {
	...
	public String index(Model model,
			            @ModelAttribute("wordSearchParams") WordSearchParams wordSearchParams,
			            @PageableDefault(page = 0, value = 10, direction = Sort.Direction.ASC, 
	                                     sort = { "word" }) Pageable pageable, 
		...
		response.getWriter().write(view.render(wordsPage, 
				                               queryParams, 
